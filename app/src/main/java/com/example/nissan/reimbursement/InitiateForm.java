...
public class InitiateForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_initiate_form);
       ...
       // Log.d("xxx",Url);
        ...
        imag.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(InitiateForm.this);
    ...
    class fetchtTask extends AsyncTask<String,Void,String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog=new ProgressDialog(InitiateForm.this);
        ...
        protected void onPostExecute(String result) {
            ...
            {
                Toast.makeText(InitiateForm.this, "Invalid Entry", Toast.LENGTH_LONG).show();
